...
define(['dojo/_base/declare',
    ...
    function (declare, lang, html, on, dojoJson, query, cookie, _WidgetsInTemplateMixin, BaseWidget, connect, PanelManager, registry, MosaicRule, domStyle, domClass) {
        ...
        var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
            ...
            _resizeContentImg: function () {
                ...
                if (this._hasContent) {
                    ...
                    if (aboutContent.nodeType && (aboutContent.nodeType === 11 || aboutContent.nodeType === 1)) {
