    ...
    NumberSpinner, CheckBox, TextBox, DropDownButton, TooltipDialog, RadioButton, LayerSwipe, ColorPalette, Dialog, NumberTextBox) {
        ...
        return declare([BaseWidget, Evented, _TemplatedMixin], {
            ...
            setBandValues: function () {
                ...
                if (this.primaryLayer.url === this.config.urlDEA) {
                    this.initialVal_green = 3;
                    this.initialVal_red = 4;
                    this.initialVal_nir = 8;
                    this.initialVal_swir = 11;
                }
                if (this.primaryLayer.url === this.config.urlPlanet) {
                    this.initialVal_green = 3;
                    this.initialVal_red = 2;
                    this.initialVal_nir = 1;
                }
                this.setMethod(registry.byId("methodMask").get("value"));
            },
            ...
            maskFunction: function (flag) {
                ...
                if (this.polygons && registry.byId('define-aoi-ch').get('checked')) {
            ...
            maskPixels: function (pixelData) {
                ...
                if (this.maskSlider) {
                    ...
                    domStyle.set("areaValueMask", "color", "rgb(" + this.color[0] + "," + this.color[1] + "," + this.color[2] + ")");
                    html.set(document.getElementById("areaValueMask"), (parseFloat((area * this.pixelSizeX * this.pixelSizeY) / (1000000 * this.scale))).toFixed(2) + " " + this.nls.unit + "<sup>2</sup>");
