        ...
        return declare([BaseWidget, Evented, _TemplatedMixin], {
            ...
            postCreate: function () {
                ...
                if (!this.dateLeft) {
                    ...
                    } else if (registry.byId("leftLayerSelector").value === "naip123") {
                        dom.byId("dateDisplay").innerHTML = "NAIP - &nbsp;&nbsp;" + locale.format(new Date(this.dateLeft), { selector: "date", formatLength: "long" });
                    } else if (registry.byId("leftLayerSelector").value === "planet123") {
                        dom.byId("dateDisplay").innerHTML = "Planet - &nbsp;&nbsp;" + locale.format(new Date(this.dateLeft), { selector: "date", formatLength: "long" });
                    } else if (registry.byId("leftLayerSelector").value === "dea123") {
                        dom.byId("dateDisplay").innerHTML = "Sentinel L2A - &nbsp;&nbsp;" + locale.format(new Date(this.dateLeft), { selector: "date", formatLength: "long" });
                    } else {
                ...
                if (!this.dateRight) {
                    ...
                    } else if (registry.byId("rightLayerSelector").value === "naip123") {
                        dom.byId("compDisplay").innerHTML = "&nbsp;&nbsp; Compared with - NAIP - &nbsp;&nbsp;" + locale.format(new Date(this.dateRight), { selector: "date", formatLength: "long" });
                    } else if (registry.byId("rightLayerSelector").value === "planet123") {
                        dom.byId("compDisplay").innerHTML = "&nbsp;&nbsp; Compared with - Planet - &nbsp;&nbsp;" + locale.format(new Date(this.dateRight), { selector: "date", formatLength: "long" });
                    } else if (registry.byId("rightLayerSelector").value === "dea123") {
                        dom.byId("compDisplay").innerHTML = "&nbsp;&nbsp; Compared with - Sentinel L2A - &nbsp;&nbsp;" + locale.format(new Date(this.dateRight), { selector: "date", formatLength: "long" });
                    } else {
            ...
            timebook: function (value) {
                if (value === "left") {
                    if (registry.byId("leftLayerSelector").value !== "none") {
                        ...
                        } else if (getLayerPropertiesLeft.id === 'naip123') {
                            this.acquisitionDateLeft = "AcquisitionDate";
                            this.titleLeft = "NAIP";
                        } else if (getLayerPropertiesLeft.id === 'dea123') {
                            this.acquisitionDateLeft = "AcquisitionDate";
                            this.titleLeft = "Sentinel L2A";
                        } else if (getLayerPropertiesLeft.id === "planet123") {
                            this.acquisitionDateLeft = "AcqDate";
                            this.titleLeft = "Planet";
                        }
            ...
            onOpen: function () {
                ...
                this.instance = 1;
                registry.byId('compareImageryOnOff').set('value', 'on');   //#270
                ...
                if (registry.byId('cloudValueLeft').get('value')) {
                    registry.byId('cloudFilterLeft').set('value', Number(registry.byId('cloudValueLeft').get('value')));
                }
                if (registry.byId('cloudValueRight').get('value')) {
                    registry.byId('cloudFilterRight').set('value', Number(registry.byId('cloudValueRight').get('value')));
                }
            ...
            onClose: function () {
                registry.byId('compareImageryOnOff').set('value', 'off');   //#270
                this.instance = 0;
                ...
                this.currentLayerProp.currentValue = null;  //#267
            },
                ...
                if (this.primaryLayer) {
                    if (value === "default") {
                        ...
                        if (this.primaryLayer.url === this.config.urlLandsatMS) {
                            ...
                            registry.byId("bnd1Left").addOption({ label: "NarrowNIR(8A)", value: "9" });
                            registry.byId("bnd1Left").addOption({ label: "Water Vapor(9)", value: "10" });
                            registry.byId("bnd1Left").addOption({ label: "SWIR(11)", value: "11" });
                            registry.byId("bnd1Left").addOption({ label: "SWIR(12)", value: "11" });
                            registry.byId("bnd1Left").set("value", "12");
                            ...
                            registry.byId("bnd2Left").addOption({ label: "NarrowNIR(8A)", value: "9" });
                            registry.byId("bnd2Left").addOption({ label: "Water Vapor(9)", value: "10" });
                            registry.byId("bnd2Left").addOption({ label: "SWIR(11)", value: "11" });
                            registry.byId("bnd2Left").addOption({ label: "SWIR(12)", value: "12" });
                            registry.byId("bnd2Left").set("value", "8");
                            ...
                            registry.byId("bnd3Left").addOption({ label: "NarrowNIR(8A)", value: "9" });
                            registry.byId("bnd3Left").addOption({ label: "Water Vapor(9)", value: "10" });
                            registry.byId("bnd3Left").addOption({ label: "SWIR(11)", value: "11" });
                            registry.byId("bnd3Left").addOption({ label: "SWIR(12)", value: "12" });
                            registry.byId("bnd3Left").set("value", "2");

                            registry.byId("stretchoptionsLeft").set("value", "clip1");
                            registry.byId("gammaoptionsLeft").set("value", "5");
                        } else if (this.primaryLayer.url === this.config.urlNaip) {
                            registry.byId("bnd1Left").addOption({ label: "Red(1)", value: "1" });
                            registry.byId("bnd1Left").addOption({ label: "Green(2)", value: "2" });
                            registry.byId("bnd1Left").addOption({ label: "Blue(3)", value: "3" });
                            registry.byId("bnd1Left").addOption({ label: "NIR(4)", value: "4" });
                            registry.byId("bnd1Left").set("value", "4");

                            registry.byId("bnd2Left").addOption({ label: "Red(1)", value: "1" });
                            registry.byId("bnd2Left").addOption({ label: "Green(2)", value: "2" });
                            registry.byId("bnd2Left").addOption({ label: "Blue(3)", value: "3" });
                            registry.byId("bnd2Left").addOption({ label: "NIR(4)", value: "4" });
                            registry.byId("bnd2Left").set("value", "3");

                            registry.byId("bnd3Left").addOption({ label: "Red(1)", value: "1" });
                            registry.byId("bnd3Left").addOption({ label: "Green(2)", value: "2" });
                            registry.byId("bnd3Left").addOption({ label: "Blue(3)", value: "3" });
                            registry.byId("bnd3Left").addOption({ label: "NIR(4)", value: "4" });
                            registry.byId("bnd3Left").set("value", "2");
                        ...
                        if (this.primaryLayer.url === this.config.urlLandsatMS) {
                            ...
                            registry.byId("bandALeft").addOption({ label: "NarrowNIR(8A)", value: "9" });
                            registry.byId("bandALeft").addOption({ label: "Water Vapor(9)", value: "10" });
                            registry.byId("bandALeft").addOption({ label: "SWIR(11)", value: "11" });
                            registry.byId("bandALeft").addOption({ label: "SWIR(12)", value: "12" });
                            registry.byId("bandALeft").set("value", "8");
                            ...
                            registry.byId("bandBLeft").addOption({ label: "NarrowNIR(8A)", value: "9" });
                            registry.byId("bandBLeft").addOption({ label: "Water Vapor(9)", value: "10" });
                            registry.byId("bandBLeft").addOption({ label: "SWIR(11)", value: "11" });
                            registry.byId("bandBLeft").addOption({ label: "SWIR(12)", value: "12" });
                            registry.byId("bandBLeft").set("value", "4");

                            registry.byId("OffsetValueLeft").set("value", "0");
                            registry.byId("ScaleLeft").set("value", "5");
                        } else if (this.primaryLayer.url === this.config.urlNaip) {
                            registry.byId("bandALeft").addOption({ label: "Red(1)", value: "1" });
                            registry.byId("bandALeft").addOption({ label: "Green(2)", value: "2" });
                            registry.byId("bandALeft").addOption({ label: "Blue(3)", value: "3" });
                            registry.byId("bandALeft").addOption({ label: "NIR(4)", value: "4" });
                            registry.byId("bandALeft").set("value", "4");

                            registry.byId("bandBLeft").addOption({ label: "Red(1)", value: "1" });
                            registry.byId("bandBLeft").addOption({ label: "Green(2)", value: "2" });
                            registry.byId("bandBLeft").addOption({ label: "Blue(3)", value: "3" });
                            registry.byId("bandBLeft").addOption({ label: "NIR(4)", value: "4" });
                            registry.byId("bandBLeft").set("value", "3");
                ...
                if (this.secondaryLayer) {
                    if (value === "default") {
                        ...
                        if (this.secondaryLayer.url === this.config.urlLandsatMS) {
                            ...
                            registry.byId("bnd1Right").addOption({ label: "NarrowNIR(8A)", value: "9" });
                            registry.byId("bnd1Right").addOption({ label: "Water Vapor(9)", value: "10" });
                            registry.byId("bnd1Right").addOption({ label: "SWIR(11)", value: "11" });
                            registry.byId("bnd1Right").addOption({ label: "SWIR(12)", value: "11" });
                            registry.byId("bnd1Right").set("value", "12");
                            ...
                            registry.byId("bnd2Right").addOption({ label: "NarrowNIR(8A)", value: "9" });
                            registry.byId("bnd2Right").addOption({ label: "Water Vapor(9)", value: "10" });
                            registry.byId("bnd2Right").addOption({ label: "SWIR(11)", value: "11" });
                            registry.byId("bnd2Right").addOption({ label: "SWIR(12)", value: "12" });
                            registry.byId("bnd2Right").set("value", "8");
                            ...
                            registry.byId("bnd3Right").addOption({ label: "NarrowNIR(8A)", value: "9" });
                            registry.byId("bnd3Right").addOption({ label: "Water Vapor(9)", value: "10" });
                            registry.byId("bnd3Right").addOption({ label: "SWIR(11)", value: "11" });
                            registry.byId("bnd3Right").addOption({ label: "SWIR(12)", value: "12" });
                            registry.byId("bnd3Right").set("value", "2");

                            registry.byId("stretchoptionsLeft").set("value", "clip1");
                            registry.byId("gammaoptionsLeft").set("value", "5");
                        } else if (this.primaryLayer.url === this.config.urlNaip) {
                            registry.byId("bnd1Right").addOption({ label: "Red(1)", value: "1" });
                            registry.byId("bnd1Right").addOption({ label: "Green(2)", value: "2" });
                            registry.byId("bnd1Right").addOption({ label: "Blue(3)", value: "3" });
                            registry.byId("bnd1Right").addOption({ label: "NIR(4)", value: "4" });
                            registry.byId("bnd1Right").set("value", "4");

                            registry.byId("bnd2Right").addOption({ label: "Red(1)", value: "1" });
                            registry.byId("bnd2Right").addOption({ label: "Green(2)", value: "2" });
                            registry.byId("bnd2Right").addOption({ label: "Blue(3)", value: "3" });
                            registry.byId("bnd2Right").addOption({ label: "NIR(4)", value: "4" });
                            registry.byId("bnd2Right").set("value", "3");

                            registry.byId("bnd3Right").addOption({ label: "Red(1)", value: "1" });
                            registry.byId("bnd3Right").addOption({ label: "Green(2)", value: "2" });
                            registry.byId("bnd3Right").addOption({ label: "Blue(3)", value: "3" });
                            registry.byId("bnd3Right").addOption({ label: "NIR(4)", value: "4" });
                            registry.byId("bnd3Right").set("value", "2");
                        ...
                        if (this.secondaryLayer.url === this.config.urlLandsatMS) {
                            ...
                            registry.byId("bandARight").addOption({ label: "NarrowNIR(8A)", value: "9" });
                            registry.byId("bandARight").addOption({ label: "Water Vapor(9)", value: "10" });
                            registry.byId("bandARight").addOption({ label: "SWIR(11)", value: "11" });
                            registry.byId("bandARight").addOption({ label: "SWIR(12)", value: "12" });
                            registry.byId("bandARight").set("value", "8");
                            ...
                            registry.byId("bandBRight").addOption({ label: "NarrowNIR(8A)", value: "9" });
                            registry.byId("bandBRight").addOption({ label: "Water Vapor(9)", value: "10" });
                            registry.byId("bandBRight").addOption({ label: "SWIR(11)", value: "11" });
                            registry.byId("bandBRight").addOption({ label: "SWIR(12)", value: "12" });
                            registry.byId("bandBRight").set("value", "4");

                            registry.byId("OffsetValueLeft").set("value", "0");
                            registry.byId("ScaleLeft").set("value", "5");
                        } else if (this.primaryLayer.url === this.config.urlNaip) {
                            registry.byId("bandARight").addOption({ label: "Red(1)", value: "1" });
                            registry.byId("bandARight").addOption({ label: "Green(2)", value: "2" });
                            registry.byId("bandARight").addOption({ label: "Blue(3)", value: "3" });
                            registry.byId("bandARight").addOption({ label: "NIR(4)", value: "4" });
                            registry.byId("bandARight").set("value", "4");

                            registry.byId("bandBRight").addOption({ label: "Red(1)", value: "1" });
                            registry.byId("bandBRight").addOption({ label: "Green(2)", value: "2" });
                            registry.byId("bandBRight").addOption({ label: "Blue(3)", value: "3" });
                            registry.byId("bandBRight").addOption({ label: "NIR(4)", value: "4" });
                            registry.byId("bandBRight").set("value", "3");
            ...
            imageSliderShow: function () {
                if (this.primaryLayer && registry.byId("imageSelectorLeft").get("checked")) {
                    ...
                    if (registry.byId('leftLayerSelector').get('value') === 'naip123' || registry.byId('leftLayerSelector').get('value') === "planet123" || registry.byId('leftLayerSelector').get('value') === 'USA_Cropland_683') {
                        document.getElementById('cloudSelectLeft').style.display = 'none';
                        query.where = layerFilter ? this.categoryField + " = 1 AND " + layerFilter : this.categoryField + " = 1";
                    
                    } else {
                        document.getElementById('cloudSelectLeft').style.display = 'block';
            ...
            imageSliderShowRight: function () {
                if (this.secondaryLayer && registry.byId("imageSelectorRight").get("checked")) {
                    ...
                    if (registry.byId('rightLayerSelector').get('value') === 'naip123' || registry.byId('rightLayerSelector').get('value') === "planet123" || registry.byId('rightLayerSelector').get('value') === 'USA_Cropland_683') {
                        document.getElementById('cloudSelectRight').style.display = 'none';
                        query.where = layerFilter ? this.categoryField + " = 1 AND " + layerFilter : this.categoryField + " = 1";
                    
                    } else {
                        document.getElementById('cloudSelectRight').style.display = 'block';
            ...
            selectDisplayedImage: function () {
                var request = new esriRequest({
                    ...
                    content: {
                        ...
                        returnGeometry: false,
                        sampleCount: 1,
                        mosaicRule: this.map.getLayer(this.currentLayerProp.id).mosaicRule ? JSON.stringify(this.map.getLayer(this.currentLayerProp.id).mosaicRule.toJson()) : this.currentLayerProp.defaultMosaicRule ? JSON.stringify(this.currentLayerProp.defaultMosaicRule.toJson()) : null,  //#267
            ...
            sliderDropDownSelection: function (value) {
                //#268
                if (this.leftlayerChanged && this.dateLeft) {
                    var diff = Math.abs(this.orderedDates[0].value - this.dateLeft);
                    this.valueSelected = 0;
                    for (let i = 0; i < this.orderedDates.length; i++) {

                        if (Math.abs(this.orderedDates[i].value - this.dateLeft) < diff) {
                            diff = Math.abs(this.orderedDates[i].value - this.dateLeft);
                ...
                this.leftlayerChanged = false;
                
            },

            sliderDropDownSelectionRight: function (value) {
                //#268
                if (this.rightlayerChanged && this.dateRight) {
                    var diff = Math.abs(this.orderedDatesRight[0].value - this.dateRight);
                    this.valueSelectedRight = 0;
                    for (let i = 0; i < this.orderedDatesRight.length; i++) {

                        if (Math.abs(this.orderedDatesRight[i].value - this.dateRight) < diff) {
                            diff = Math.abs(this.orderedDatesRight[i].value - this.dateRight);
                            this.valueSelectedRight = i;
                        }
                    }
