...
define({
    root: ({
		...
		changeDetectionCheckbox: "Detect change between two different dates",
		sameSensorRule: "Note: The selected sensor must be the same for both  images",
        ...
        sameDateWarning: "Note: To detect change, choose individual images for both",
