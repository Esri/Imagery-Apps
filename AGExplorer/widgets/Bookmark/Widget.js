...
define([
  ...
  function (declare, lang, array, html, BaseWidget, on, aspect, string,
    SpatialReference, ImageNode, TileLayoutContainer, utils, store, dom, registry, Dialog, domConstruct, connect, PanelManager, domClass, ImageChooser, MosaicRule) {
    ...
    return declare([BaseWidget], {
      ...
      startup: function () {
        ...
        this.bookmarkList = new TileLayoutContainer({
          strategy: 'fixCols',
          itemSize: { height: ((90 / 130) * 100) + '%', width: '90%' },
          maxCols: 2
        ...
        this.imageChooserWid = new ImageChooser({
          cropImage: true,
        ...
        html.addClass(this.imageChooserWid.domNode, 'img-chooser');
        html.place(this.imageChooserWid.domNode, this.imageChooserWidget, 'replace');
      },
      ...
      displayBookmarks: function () {
        ...
        this._switchPlayBtn();
        this.resize();
        this.imageChooserWid.selfImg.src = this.folderUrl + "images/thumbnail_default.png";
      },
      ...
      _createBookmark: function () {
        ...
        if (this.appConfig.map['3D']) {
          ...
          b = {
            ...
            thumbnail: this.imageChooserWid.imageData
          };
        }
