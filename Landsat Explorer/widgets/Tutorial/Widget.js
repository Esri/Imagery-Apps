            ...
            var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
                ...
                postCreate: function () {
                    ...
                    this.resizeDialog();
                     ...
                     /*   this.myTooltipDialog.on("close", lang.hitch(this, function(){
                               if(!this.closeTooltipDialog) {
                                   console.log( registry.byId("tooltipDialogIntro"));
                             registry.byId("tooltipDialogIntro").show();
                               }else
                             this.closeTooltipDialog = false;
      ...
      registry.byId("tutorialStage").set("value",tutorialStageValue);
               ...
               x[0].click();
                   ...
                   popup.close(tooltipTemp);
                     ...
                     /*  if(domClass.contains(x[8],"jimu-state-selected"))
