...
continueTutorial: function(value){
    ...
    if(value === "37"){
        tooltipTemp.set("content","<p style='text-align:justify;display:inline;'>Build your own story. Using the tools you've learned so far, <span style='color:orange;font-weight:bolder;'>create a Color Infrared map of your hometown.</span> You can search for a new location using the <span style='color:orange;font-weight:bolder;'>Find a place' searchbar</span> in the top left.<br />When you're done,<div id='continueComment' style='color:orange;font-weight:bolder;cursor:pointer;display:inline-block;'>Click here to continue.</div></p>");
         registry.byId("tutorialStage").set("value","38");
         on(dom.byId("continueComment"),"click",lang.hitch(this,this.continueTutorial,"38"));
         dom.byId("bandCombination").style.pointerEvents = "auto";
    }else if(value === "38"){
        tooltipTemp.set("content","<p style='text-align:justify;display:inline;'><span style='color:orange;font-weight:bolder;'>Click <img src='http://landsatexplorer.s3-website-us-west-2.amazonaws.com/widgets/Story/images/icon.png' height='15' /></span> to create an image story map based on your new image. Sign in to ArcGIS Online if you haven't yet.</p>");
         registry.byId("tutorialStage").set("value","39");
         document.getElementsByClassName("icon-node")[8].style.pointerEvents = "auto";
    }
     popup.open({
                   popup: tooltipTemp,
                   orient: ["after-centered"],
                   around: document.getElementsByClassName("icon-node")[8],
      ...
      addClicked: function() {
        ...
        if (this.canRemove) {
            if(registry.byId("tooltipDialogIntro") && registry.byId("tooltipDialogIntro").state === "open" && registry.byId("tutorialStage").get("value")==="36"){
              ...
              //tooltipTemp.set("content","<p style='text-align:justify;'>The <span style='color:orange;font-weight:bolder;'>Story Builder</span> offers another option for sharing your imagery. It allows you to gather and annotate a series of images in a story map, which you can then save and share using ArcGIS Online.<div id='continueComment' style='color:orange;font-weight:bolder;cursor:pointer;'>Click here to continue.</div></p>");
                ...
                /*  popup.open({
                   ...
                   around: document.getElementsByClassName("icon-node")[8],
                    onClose: lang.hitch(this, function(){
                     ...
                     domStyle.set(tooltipTemp.connectorNode,"top","0px");
                       registry.byId("tutorialStage").set("value","37");*/
                  ...
                  //on(dom.byId("continueComment"),"click",lang.hitch(this, self.continueTutorial,"37"));
           }
