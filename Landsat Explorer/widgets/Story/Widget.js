...
define([
    ...
    'dojox/editor/plugins/LocalImage'
        ...
        this.hideLoading();
                  ...
                  domStyle.set("editSectionList","display","none"); domStyle.set("editSectionList","height","0px");
            ...
            createShortLink: function(id){
                var request = new XMLHttpRequest();
                    ...
                    if(appUrl.includes("?"))
                        ...
                        request.open("Get","https://api-ssl.bitly.com/v3/shorten?login=arcgis&apiKey=R_b8a169f3a8b978b9697f64613bf1db6d&longUrl="+shortUrl, true);
                        request.send();
            },
                editSections: function(){
                  ...
                  domStyle.set("editSection","color","white");
                   domStyle.set("organize","background-color","");
                  domStyle.set("organize","color","");
                  domStyle.set("organizeList","display","none");domStyle.set("organizeList","height","0px");
