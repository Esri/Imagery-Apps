        ...
        function (
            ...
            var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
                ...
                postCreate: function () {
                    ...
                    this.landsatTurnOn = lang.hitch(this, function (event) {
                        this.primaryLayer = this.map.getLayer("landsatLayer");
                        domStyle.set("timeError", "display", "none");
                    ...
                    this.landsatTurnOff = lang.hitch(this, function (event) {
                        this.primaryLayer = null;
                        this.toolbarTemporal.deactivate();
                        domStyle.set("access", "display", "none");
                        domStyle.set("timeError", "display", "block");
                        html.set(this.temporalpro, "");
                        domStyle.set(this.filterDiv, "display", "none");
                    });
                ...
                sliderChange: function () {
                    ...
                    if (this.orderedFeatures1.length) {
