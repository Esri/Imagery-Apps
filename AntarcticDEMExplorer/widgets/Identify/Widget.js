                            ...
                            queryTask.execute(query, lang.hitch(this, function (queryResult) {
                                ...
                                queryTask2.execute(query2, lang.hitch(this, function (queryResult2) {
                                    ...
                                    request5.then(lang.hitch(this, function (data) {
                                        ...
                                        html.set(this.identifytab, "<table style='border: 0px;'><tr><td><b>Current Scene ID:</b> " + props.GroupName + "</td><td>&nbsp;&nbsp;<b>Product Name:</b> " + props.ProductName + "</td></tr><tr><td><b>Acquisition Date:</b> " + locale.format(new Date(props.AcquisitionDate), {selector: "date", formatLength: "long"}) + "</td><td>&nbsp;&nbsp;<b>WRS Path/Row:</b> " + props.WRS_Path + "/" + props.WRS_Row + "</td></tr><tr><td><b>Sun Azimuth:</b> " + props.SunAzimuth.toFixed(1) + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Sun Elevation:</b> " + props.SunElevation.toFixed(1) + "</td><td>&nbsp;&nbsp;<b>Cloud Cover:</b> " + (props.CloudCover * 100).toFixed(1) + "%</td></tr></table>");
...
//                                        } else
                    ...
                    if (request2) {
                        request2.then(lang.hitch(this, function (data) {
                            ...
                            {
                                var pixelValue = data.processedValues[0].split(" ");
                                ...
                                var request3 = esriRequest({
                                    ...
                                    content: {
                                        ...
                                        // returnCatalogItems: true,
                                        returnFirstValueOnly: true,
                                        outFields: 'Name,Category,LowPS,Source',
                                        mosaicRule: this.mosaic,
                                        f: "json"
                                    },
                                    handleAs: "json",
...
//                                    this.sourceUrl = props.fileurl;
                                      var date = 946684800000 + (parseInt(pixelValue[2]) * 24 * 60 *60 * 1000);          
                                    html.set(this.identifytab, "<table style='border: 0px;'><tr><td><b>Current Scene ID: </b> " + props.Name + "</td><td><b>Source: </b> " + props.Source + "</td></tr><tr><td><b>Imagery Date: </b>"+locale.format(new Date(date), {selector: "date", formatLength: "long"})+"</td><td><b>Estimated Accuracy:</b> "+parseFloat(pixelValue[1]).toFixed(1)+"</td></tr><tr><td><b>PixelSize: </b> " + props.LowPS + "m&nbsp;&nbsp;&nbsp;<b>Aspect: </b> " + parseInt(data.processedValues[2]) + " deg" + "</td><td><b>Slope: </b> " + parseInt(data.processedValues[1]) + " deg" + "</td></tr><tr><td><b>Orthometric height: </b> " + (parseFloat(pixelValue[0])).toFixed(2) + "m" + "</td><td><b>Ellipsoidal height: </b> " + (parseFloat(data.processedValues[3])).toFixed(2) + "m" + "</td></tr></table>");
                ...
                refreshData: function () {
                    ...
                    if (this.map.layerIds) {
                        ...
                        try {
                            ...
                            this.bandPropMean = [978.908205346472, 3213.94098296795, 2641.93844367015, 978.908205346472, 978.908205346472, 978.908205346472, 978.908205346472, 978.908205346472];
                    ...
                    if (registry.byId("footprintId").checked) {
                        ...
                        if (this.map.getLayer("primaryLayer")) {
                            var url = this.config.urlElevationPGC;
                             query.where = "(Category=1) AND (Name = '" + this.groupName + "')";
                        }else if (this.map.getLayer("landsatLayer")) {
