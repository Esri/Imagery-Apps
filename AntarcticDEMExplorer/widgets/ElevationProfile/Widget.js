        ...
        function (
            ...
            var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
                ...
                /*getProfileOfRasters: function(geometry){
                 ...
                 query.outFields = ["AcquisitionDate","OBJECTID"];
                 ...
                 acquisitionDate[i] = locale.format(new Date(result.features[i].attributes.AcquisitionDate), {selector: "date", formatLength: "long"});
                 }
                 var distance = 0;
