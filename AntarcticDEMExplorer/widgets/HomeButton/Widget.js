        ...
        function (
            ...
            var clazz = declare([BaseWidget], {
                ...
                startup: function () {
                    ...
                    var extent1 = new esri.geometry.Extent(-6071520.742554906,-3549067.6990747834,7473530.077367318,3570479.6740413615, new esri.SpatialReference({wkid: 3031}));
                ...
                onAppConfigChanged: function (appConfig, reason, changedData) {
                    if (reason === "mapChange" && changedData &&
                        ...
                        var extent = new Extent({
                            "xmin": -6071520.742554906,
                "ymin": -3549067.6990747834,
                "xmax": 7473530.077367318,
                "ymax": 3570479.6740413615,
                            "spatialReference": {
                                "wkid": 3031
                            }
                        });
