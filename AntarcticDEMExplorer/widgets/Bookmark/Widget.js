...
function(declare, lang, array, html, BaseWidget, on, aspect, string,
  SpatialReference, ImageNode, TileLayoutContainer, utils, store, dom, registry, Dialog, domConstruct, connect,PanelManager,domClass) {
...
if(!domClass.contains(dom.byId(bookmark.layer),"selected"))
