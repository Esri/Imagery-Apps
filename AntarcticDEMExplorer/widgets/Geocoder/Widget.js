...
define([
  ...
  function(
    ...
    html, on,domStyle,lang, Deferred, all,
    ...
    var clazz = declare([BaseWidget], {
      ...
      lastMgrsResult: null,
       defaultExtent: new Extent({"xmin": -2699999.4723000005,
              "ymin": -2200000.417199998,
              "xmax": 2800000.5276999995,
              "ymax": 2299999.582800002,
      ...
      _initGeocoder: function() {
        this._getGeocoders(this.appConfig.portalUrl).then(lang.hitch(this, function() {
          ...
          geocoder.on("load", lang.hitch(this, function() {
              if(geocoder.sources.length > 4) {
                  geocoder.sources.splice(5);
              }
          }));
          geocoder.startup();
