...
define([
    ...
    function (declare, BaseWidget, PanelManager, _WidgetsInTemplateMixin, _TemplatedMixin, template, IdentityManager, Mask, Identify, Temporal, registry, lang, Evented, html, domClass, domAttr, dom, MosaicRule, Query, QueryTask, Extent, locale, domConstruct,
        ...
        ImageServiceParameters, ImageServiceIdentifyTask, ImageServiceIdentifyParameters, RasterFunction, Polygon, Point, esriRequest, Tooltip, ColorPalette, Button) {
                ...
                if (registry.byId("imageViewer").get("checked")) {
                    if (this.valueSelected || this.valueSelected === 0) {
                        ...
                        if (registry.byId("layerSelectorView").value === "MS_696") {
                            ...
                            dom.byId("dateDisplay").innerHTML = "Setinel 2 - &nbsp;&nbsp;" + locale.format(new Date(this.date), { selector: "date", formatLength: "long" });
                        } else {
                            dom.byId("dateDisplay").innerHTML = "Basemap";
                        }
