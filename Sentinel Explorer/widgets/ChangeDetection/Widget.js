            ...
            var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
                ...
                changeInVeg: function () {
                    ...
                    if (registry.byId("changeOptions").get("value") === "NDVI") {
                        var method = 0;
                        var bandIndexes = "(B8 - B4)/(B8 + B4)";
                    } else {
                        var method = 0;
                        var bandIndexes = "(1.5 * (B8 - B4))/(B8 + B4 +5000)";
                    }
                    var layer = this.map.getLayer("primaryLayer");
                    var layer2 = this.map.getLayer("secondaryLayer");
                ...
                changeInWater: function () {
                    ...
                    args1.Method = 0;
                    args1.BandIndexes = "(B3-B12)/(B3+B12)";
                    raster1.outputPixelType = "F32";
                    raster1.functionArguments = args1;
                    ...
                    args2.Method = 0;
                    args2.BandIndexes = "(B3-B12)/(B3+B12)";
                    raster2.functionArguments = args2;
                    raster2.outputPixelType = "F32";
                ...
                changeInBurn: function () {
                    ...
                    args1.Raster = "$" + layer.mosaicRule.lockRasterIds[0];
                    args1.Method = 0;
                    args1.BandIndexes = "(B8 -B13)/(B8+B13)";
                    raster1.outputPixelType = "F32";
                    raster1.functionArguments = args1;
                    ...
                    args12.Method = 0;
                    args12.BandIndexes = "(B3-B12)/(B3+B12)";
                    ...
                    args2.Method = 0;
                    args2.BandIndexes = "(B8 -B13)/(B8+B13)";
                    raster2.functionArguments = args2;
                    raster2.outputPixelType = "F32";
                    ...
                    args22.Method = 0;
                    args22.BandIndexes = "(B3-B12)/(B3+B12)";
                ...
                changeInUrban: function () {
                    ...
                    args1.Raster = "$" + layer.mosaicRule.lockRasterIds[0];
                    args1.Method = 0;
                    args1.BandIndexes = "(((B12 - B8)/(B12 + B8)) + ((B4 - B8)/(B8 + B4)))";
                    raster1.outputPixelType = "F32";
                    raster1.functionArguments = args1;
                    ...
                    args2.Raster = "$" + layer2.mosaicRule.lockRasterIds[0];
                    args2.Method = 0;
                    args2.BandIndexes = "(((B12 - B8)/(B12 + B8)) + ((B4 - B8)/(B8 + B4)))";
                    raster2.functionArguments = args2;
                    raster2.outputPixelType = "F32";
                    var composite = new RasterFunction();
                    var compositeArg = {};
