        ...
        function (
            ...
            var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
                ...
                postCreate: function () {
                    ...
                    on(dom.byId("titleNext"), "click", lang.hitch(this, function () {
                        ...
                        if (registry.byId("titleStage").get("value")) {
                            ...
                            // domStyle.set("defineSteps","display","block");
                ...
                loadAppStories: function (id) {
                    ...
                    window.open("?story=" + id, "_blank"); //enter app url before ?
                },
                        ...
                        if (this.updateMode) {
                            ...
                            var addItemRequest = esriRequest({
                                ...
                                content: {f: "json",
                                    ...
                                    description: "Json file for configuring Sentinel Explorer story",
                                    tags: "Imagery Story App, Sentinel Explorer, Story",
                                    async: true,
                                    itemType: "file",
                                    overwrite: false
                                },
                ...
                createShortLink: function (id) {
                    ...
                    request.open("Get", "https://api-ssl.bitly.com/v3/shorten?login=&apiKey=&longUrl=" + shortUrl, true); //enter login and apikey for bitly
                    request.send();
                },
                ...
                setPropertiesOnLayer: function (state) {
                    ...
                    if (this.map.getLayer("secondaryLayer") && this.map.getLayer("secondaryLayer").url !== this.config.urlSentinel) {

                        this.map.getLayer("secondaryLayer").suspend();
                        this.map.removeLayer(this.map.getLayer("secondaryLayer"));
                    }
                    if (this.map.getLayer("primaryLayer") && this.map.getLayer("primaryLayer").url !== this.config.urlSentinel)
                    {
                    ...
                    this.map.setExtent(new Extent(JSON.parse(state.extent))).then(lang.hitch(this, function () {
                        ...
                        if (state.secondary.mosaicRule) {
                            ...
                            if (currentSecondaryLayer && currentSecondaryLayer.url === this.config.urlSentinel) {
                                ...
                                currentSecondaryLayer.setMosaicRule(new MosaicRule({"mosaicMethod": "esriMosaicAttribute", "sortField": "Best", "sortValue": 0, "ascending": true, "where": "Name = '" + state.secondary.mosaicRule + "'", "mosaicOperation": "MT_FIRST"}), false);
                            } else {
                                ...
                                paramsSecondary.mosaicRule = state.secondary.mosaicRule ? new MosaicRule({"mosaicMethod": "esriMosaicAttribute", "sortField": "Best", "sortValue": 0, "ascending": true, "where": "Name = '" + state.secondary.mosaicRule + "'", "mosaicOperation": "MT_FIRST"}) : null;
                                var secondaryLayer = new ArcGISImageServiceLayer(this.config.urlSentinel, {
                                    id: "secondaryLayer",
                        ...
                        if (state.primary.renderingRule) {
                            ...
                            if (currentPrimaryLayer && currentPrimaryLayer.url === this.config.urlSentinel) {
                                if (state.primary.mosaicRule) {
                                    currentPrimaryLayer.setMosaicRule(new MosaicRule({"mosaicMethod": "esriMosaicAttribute", "sortField": "Best", "sortValue": 0, "ascending": true, "where": "Name = '" + state.primary.mosaicRule + "'", "mosaicOperation": "MT_FIRST"}), true);
                                } else
                                ...
                                //       this.map.removeLayer(currentPrimaryLayer);
                                ...
                                paramsPrimary.mosaicRule = state.primary.mosaicRule ? new MosaicRule({"mosaicMethod": "esriMosaicAttribute", "sortField": "Best", "sortValue": 0, "ascending": true, "where": "Name = '" + state.primary.mosaicRule + "'", "mosaicOperation": "MT_FIRST"}) : null;
                                var primaryLayer = new ArcGISImageServiceLayer(this.config.urlSentinel, {
                                    id: "primaryLayer",
                        ...
                        if (state.result.renderingRule) {
                            ...
                            if (state.result.changeMask === "change") {
                                var query = new Query();
                                query.where = "Name = '" + state.secondary.mosaicRule + "' OR Name = '" + state.primary.mosaicRule + "'";
                ...
                loadResultLayer: function (rendererJson, state) {
                    if (!this.map.getLayer("resultLayer")) {
                        ...
                        var resultLayer = new RasterLayer(this.config.urlSentinel, {
                            id: "resultLayer",
                            visible: true,
                ...
                saveStage: function (mode) {
                    ...
                    var primaryProperties = {renderingRule: renderingRulePrimary, mosaicRule: mosaicRulePrimary, visible: shareLayer.visible, bandIds: shareLayer.bandIds};
                    ...
                    if (this.map.getLayer("secondaryLayer") && ((registry.byId("changeDetectionDialog") && registry.byId("changeMaskDetect").get("value") === "change") || swipe)) {
                        ...
                        var secondaryProperties = {renderingRule: renderingRuleSecondary, mosaicRule: mosaicRuleSecondary, visible: secondaryLayer.visible, bandIds: secondaryLayer.bandIds};
                    } else {
                        var secondaryProperties = {renderingRule: null, mosaicRule: null, visible: null, bandIds: null};
                    }
                ...
                setChangeMaskParameters: function () {
                    if (registry.byId("maskDialog") && registry.byId("changeMaskDetect").get("value") === "mask") {
                        ...
                        var maskColor = wm.getWidgetById("widgets/Mask/Widget_40").color;
                ...
                onOpen: function () {
                    ...
                    if (wm.getWidgetById("_8").storyModeOn) {
                        ...
                        /*      var getGroupRequest = esriRequest({
                         ...
                         content: {q:"group:f09ff913ab7f4422b9cae09ade905cf7",sortField:"title",sortOrder:"asc",num: 100,f: "json"}, //load Stories from a group on arcgis online.
                         handleAs: "json",
                         callbackParamName: "callback"
                         });
