...
define(["dojo/_base/declare",
    ...
    "jimu/portalUtils",
    "jimu/tokenUtils",
    "jimu/BaseWidget", "esri/arcgis/Portal", "dijit/registry", "dojo/dom", "dijit/popup", "dojo/dom-style",
            ...
            return declare([BaseWidget, _WidgetsInTemplateMixin], {
                ...
                onOpen: function () {
                    ...
                    if (registry.byId("tooltipDialogIntro") && registry.byId("tooltipDialogIntro").state === "open" && registry.byId("tutorialStage").get("value") === "32") {
                        ...
                        tooltipTemp.set("content", "<p style='text-align: justify;'>Click the dropdown menu to change My Organization to <span style='font-weight:bolder;color:orange;'>ArcGIS Online.</span></p>");
                        popup.open({
                            parent: registry.byId("Add Data from ArcGIS Online"),
                            popup: tooltipTemp,
                            orient: ["after-centered"],
                            around: dom.byId("uniqName_9_0"),
                            onClose: lang.hitch(this, function () {
                                domStyle.set(tooltipTemp._popupWrapper, "display", "block");
                            })
                        });
                        document.getElementsByClassName("icon-node")[5].style.pointerEvents = "none";
                        domStyle.set(tooltipTemp.connectorNode, "top", "0px");
                        registry.byId("tutorialStage").set("value", "33");
                    }
