...
domStyle.set(this._dialog.id,"left","160px");
                        domStyle.set(this._dialog.id,"top","70px");
                        domStyle.set(this._dialog.id,"position","fixed");
                      //  domStyle.set(this._dialog.id,"width","25%");
                      //  domStyle.set(this._dialog.id,"height","40%");
