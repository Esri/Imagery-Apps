...
independentWidgets: [],
      ...
      _onIconClick: function(node) {
       ...
       if(node.config.id === "_28" || node.config.id === "_30" ||node.config.id === "_32" || node.config.id === "_42" || node.config.id === "_40" || node.config.id === "_50" || node.config.id === "_60"){
  ...
  //  } 
   ...
   if(id !== "_28" && id !== "_30" && id !== "_40" && id !== "_42" && id !== "_32" && id !== "_50" && id !== "_60")
        this.openedId = '';
      },

      _showIconContent: function(iconConfig) {
        this.panelManager.showPanel(iconConfig).then(lang.hitch(this, function(panel) {
            if(iconConfig.id !== "_28" && iconConfig.id !== "_30" && iconConfig.id !== "_32" && iconConfig.id !== "_40" && iconConfig.id !== "_42" && iconConfig.id !== "_50" && iconConfig.id !== "_60")
