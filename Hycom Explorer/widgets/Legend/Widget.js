...
define([
    ...
    'jimu/BaseWidget',
    'jimu/LayerInfos/LayerInfos', "dijit/registry", "dojo/dom", "dojo/dom-style", "dojo/dom-class",
    'esri/dijit/Legend'
], function (declare, lang, html, on, legendUtils,
        _WidgetsInTemplateMixin, BaseWidget, LayerInfos, registry, dom, domStyle, domClass, Legend) {
    ...
    var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
        ...
        onOpen: function () {
            ...
            this.legend = new Legend(legendParams, html.create("div", {style: {position: "absolute", width: "85px", height: "calc(100% - 295px)", overflow: "auto", marginLeft: "10px"}}, "themes_LandsatTheme_widgets_HeaderController_Widget_71", "last"));
            this.legend.startup();
            this._bindEvent();
        },
        onClose: function () {
        ...
        _getLayerInfosParam: function () {
            ...
            for (var a = layerInfosParam.length - 1; a >= 0; a--) {
                if ((layerInfosParam[a].title).includes("World_Ocean_Reference")){
                    layerInfosParam.splice(a - layerInfosParam.length, 1);
                }else if ((layerInfosParam[a].title).includes("rest - rest - "))
                    layerInfosParam[a].title = layerInfosParam[a].title.split("rest - rest -")[1];
                else if ((layerInfosParam[a].title).includes("rest - "))
                    layerInfosParam[a].title = layerInfosParam[a].title.split("rest - ")[1];
            }
